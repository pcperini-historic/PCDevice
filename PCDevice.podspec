#
#  Be sure to run `pod spec lint PCDevice.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of PCDevice in Markdown format.
  ...
  s.homepage     = "https://github.com/pcperini/PCDevice"
  ...
  s.source       = { :git => "https://github.com/pcperini/PCDevice.git", :tag => "v1.0.0" }
